...
List setting_section_two = [
  {"icon": Icons.privacy_tip, "text": "Account", "color": Colors.blue[700]},
  {"icon": Icons.maps_ugc_outlined, "text": "Chats", "color": Colors.green},
  {
...
const List messages = [
  ...
  {
    "isMe": true,
    "message": "Around 10 people",
    "time": "8:10 AM",
    "isLast": false,
  },
  {
    "isMe": true,
    "message": "Consider places...",
    "time": "8:19 AM",
    "isLast": false,
  },
  {
    "isMe": true,
    "message": "Will confirm the place.",
    "time": "8:20 AM",
    "isLast": false,
  },
  {
